 ...
 * @author rupesht
 */
@ManagedBean(name = "createeventBean")
@ViewScoped
public class CreateEventBean extends AbstractMB {
    ...
    public void init() {
        ...
        eventMasterList = eventMasterDAO.getEventMasterList(loginBean.getLoginUserId());
    ...
    public void saveEvent() {
        try {
            ...
            if (eventMasterDAO.insertEventMaster(eventMasterDTO)) {
                showMessageInDialog("Event added successfully");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            if (eventMasterDTO != null && eventMasterDTO.getEventId() != null) {
                ...
                if (superCategoryDAO.insertSuperCategory(superCategoryTktDTO)) {
                    showMessageInDialog("Super category inserted successfully");
        ...
        try {
            if (superCategoryTktDTO != null) {
                if (superCategoryDAO.deleteSuperCategory(superCategotyId)) {
                    showMessageInDialog("Super category Deleted successfully");
                    superTicketCategoryDTOList = superCategoryDAO.getSuperCategoryList(eventMasterDTO.getEventId());
                }
            } else {
                displayErrorMessageToUser("Please Enter event first");
    ...
    public void updateTicketDetails() {
        try {
            ...
            if (ticketDAO.updateTicketMaster(ticket)) {
                showMessageInDialog("Ticket updated successfully");
                ticketDTOList = ticketDAO.getTicketList(eventMasterDTO.getEventId());
                ticket = new TicketDTO();
            }
        } catch (Exception e) {
    ...
    public void deleteTicketDetails(int ticketCategoryId) {
        try {
            if (ticketDAO.deleteTicketMaster(ticketCategoryId)) {
                showMessageInDialog("Ticket deleted successfully");
                ticketDTOList = ticketDAO.getTicketList(eventMasterDTO.getEventId());
                ticket = new TicketDTO();
            }
        } catch (Exception e) {
    ...
    public void deleteEvent(EventMasterDTO eventMasterDTO) {
        try {
            if (eventMasterDAO.deleteEventMaster(eventMasterDTO.getEventId())) {
                displayInfoMessageToUser("Event deleted successfully");
                eventMasterList = eventMasterDAO.getEventMasterList(loginBean.getLoginUserId());
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void updateEvent(EventMasterDTO eventMasterDTO) {
        try {
            if (eventMasterDAO.updateEventMaster(eventMasterDTO)) {
                displayInfoMessageToUser("Event deleted successfully");
                eventMasterList = eventMasterDAO.getEventMasterList(loginBean.getLoginUserId());
            }
        } catch (Exception e) {
